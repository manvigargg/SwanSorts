...
function drawBoxes(canvas, imgEl, detections) {
  ...
  // Model coordinates → displayed image coordinates
  ...
  detections.forEach(d => {
    ...
    // Place above box.
    // If there isn't enough room, place inside.
    const pillX = x1
...
export default function Scan() {
  ...
  const startCam = async () => {
    try {
      ...
      alert(
        `Camera error: ${err.message}. Please allow camera access in your browser settings.`
      )
    }
  }
      ...
      >
        ...
        <div
          style={{
            ...
            padding:
              '48px 44px 48px 60px',
            borderRight:
              '1px solid rgba(168,224,99,0.07)',
            overflowY: 'auto',
          }}
        >
          ...
          >
            ...
            >
              Upload an image or use your
              camera. Swan detects and
              labels each item with a
              bounding box.
            </p>
            ...
            {mode === 'upload' && (
              <div
                ...
                style={{
                  border:
                    '1.5px dashed rgba(168,224,99,0.22)',
                  borderRadius: 14,
                  padding:
                    '32px 20px',
                  textAlign: 'center',
                ...
                onMouseEnter={e =>
                  (e.currentTarget.style.borderColor =
                    'rgba(168,224,99,0.48)')
                }
                onMouseLeave={e =>
                  (e.currentTarget.style.borderColor =
                    'rgba(168,224,99,0.22)')
                }
              >
        ...
        <div
          style={{
            ...
            overflowY: 'auto',
            background:
              'radial-gradient(ellipse at center, rgba(13,31,15,0.6) 0%, var(--ink) 70%)',
          }}
        >
